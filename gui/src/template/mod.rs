...
pub use generated::{
    ...
    CANVAS_PENDING_CONNECTION_TEMPLATE, CANVAS_ROOT_TEMPLATE, CONTROL_TEMPLATE,
    DROPDOWN_OVERLAY_TEMPLATE, NODE_PALETTE_CATEGORY_TEMPLATE, NODE_PALETTE_EMPTY_TEMPLATE,
    NODE_PALETTE_ITEM_TEMPLATE, NODE_PALETTE_TEMPLATE, PANEL_FRAME_TEMPLATE, TEXT_BOX_TEMPLATE,
